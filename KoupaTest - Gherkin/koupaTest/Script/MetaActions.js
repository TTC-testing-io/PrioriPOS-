...
function PrioriPOSCashPaiement(AccountName) {
    ...
    KeyActions.FormIsDisplayed("PrioriPOSGUI", "MainMenu");
    KeyActions.ClickButton("PrioriPOSGUI", "MainMenu", "Transaction");
    KeyActions.FormIsDisplayed("PrioriPOSGUI", "Transaction");
    KeyActions.SetField("PrioriPOSGUI", "Transaction", "SalesMan", SalesMan);    
    KeyActions.SetCellValue("PrioriPOSGUI", "Transaction", "TransactionItems",1 ,'מק"ט', 11);
